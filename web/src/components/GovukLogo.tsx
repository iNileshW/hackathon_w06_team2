// The official GOV.UK logotype: Tudor Crown + "GOV.UK" wordmark, taken from
// govuk-frontend's logo macro. Inline SVG so it needs no image asset.
export default function GovukLogo() {
  return (
    <svg
      focusable="false"
      role="img"
